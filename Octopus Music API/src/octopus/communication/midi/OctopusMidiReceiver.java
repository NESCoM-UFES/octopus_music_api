 ...
 */
public abstract class OctopusMidiReceiver implements Receiver, OctopusReceiver {
        public static String mensagem =  "";

        private static Hashtable<String, Long> notasTocadas = new Hashtable<String, Long>();
        ...
        public abstract void performAction(MidiMessage message, long lTimeStamp, String strText);
       ...
       public  String decodeMessage(MidiMessage message){
         String	strMessage = null;
               ...
               {
                       strMessage = "tipo de mensagem MIDI desconhecida";
               }
		...
		public void send(MidiMessage message, long lTimeStamp){
                ...
                /*if(nLength>0){
                  append("[");
                  append(getHexString(abData, 0, nLength));
                  append("] ");
                }*/
                ...
                {
                        strMessage = decodeMessage((ShortMessage) message);
                        note = getKeyName(((ShortMessage) message).getData1());
                }
                else if (message instanceof SysexMessage)
                {
                        strMessage = decodeMessage((SysexMessage) message);
                ...
                if((!strMessage.equalsIgnoreCase("Timing Clock")) & (!strMessage.equalsIgnoreCase("Active Sensing"))){
                   if(strMessage.indexOf("note On")!= -1){
                    notasTocadas.put(note,new Long(lTimeStamp));
                    performAction( message,  lTimeStamp, strMessage);
                  }else{
        ...
        private String decodeMessage(ShortMessage message)
        {
                ...
                case 0x90:
                  if(message.getData2()!= 0){
                    ...
                    // notasTocadas.put(message.getData1(),)
                     break;
                  }else{
                    strMessage = "note Off " + getKeyName(message.getData1()) + " velocity: " + message.getData2();
                    break;
        ...
        private String decodeMessage(SysexMessage message)
        {
                ...
                if (message.getStatus() == SysexMessage.SYSTEM_EXCLUSIVE)
                {
                        ...
                        {
                                // strMessage += MANUFACTURER_ID_THREE_BYTE[/*nManufacturer*/] + " (" + getHexString(abData, nStart - 1, 1) + ") ";
...
// 		return strData;
        ...
        /**	TODO:
                ...
                {@link #getHexString(byte[], int, int)
