...
public class AppTesteEGIT {
	//add your method too!
		public static void llcostalongaSaysDoWhatever(){
		...
		public static void main(String[] args) {
		   ...
		   * Then, add your own method to do whatever. The goal is to see how GIT merge things.
		   */
