...
// É verificada a relação do intervalo com a distância da notaFundamental.
// É atualizada a oitava do objeto nota. Para retornar a Note desejada verifica-se
...
// através do intervaloNumerico se o retorno será uma Note Bemolizada ou Sustenizada.
/*
     ...
     if (notaRetorno == null){
          ...
          if (notas[intervaloNumerico - 1] == notasCromaticas[proximaNota]) {
            ...
            if (notas[intervaloNumerico - 1] == notasCromaticas[notaAnterior]) {
              ...
              System.out.println("Não consegui achar a nota deste intervalo");
            }
          }
