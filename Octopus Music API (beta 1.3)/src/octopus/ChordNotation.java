 ...
 */
  private void configSymbols(){
    ...
    alteracoesTemp = null;
    //Intervalos
    fundamentalInterval = new IntervalSymbol(strIntervals[0], IntervalFactory.getRoot());
    minorSecondInterval = new IntervalSymbol(strIntervals[1], IntervalFactory.getMinorSecond());
    majorSecondInterval = new IntervalSymbol(strIntervals[2], IntervalFactory.getMajorSecond());
    augmentedSecondInterval = new IntervalSymbol(strIntervals[3], IntervalFactory.getAugSecond());
    minorThirdInterval = new IntervalSymbol(strIntervals[4], IntervalFactory.getMinorThird());
    majorThirdInterval = new IntervalSymbol(strIntervals[5], IntervalFactory.getMajorThird());
    perfectFourthInterval = new IntervalSymbol(strIntervals[6], IntervalFactory.getDimFourth());
    perfectFourthInterval = new IntervalSymbol(strIntervals[7], IntervalFactory.getPerfectFourth());
    augmentedFourthInterval = new IntervalSymbol(strIntervals[8], IntervalFactory.getAugFourth());
    diminishedFifthInterval = new IntervalSymbol(strIntervals[9], IntervalFactory.getDimFifth());
    perfectFifthInterval = new IntervalSymbol(strIntervals[10], IntervalFactory.getPerfectFifth());
    augmentedFifthInterval = new IntervalSymbol(strIntervals[11], IntervalFactory.getAugFifth());
    minorSixthInterval = new IntervalSymbol(strIntervals[12], IntervalFactory.getMinorSixth());
    majorSixthInterval = new IntervalSymbol(strIntervals[13], IntervalFactory.getMajorSixth());
    perfectFourthInterval = new IntervalSymbol(strIntervals[14], IntervalFactory.getAugSixth());
    diminishedSeventhInterval = new IntervalSymbol(strIntervals[15], IntervalFactory.getDimSeventh());
    minorSeventhInterval = new IntervalSymbol(strIntervals[16], IntervalFactory.getMinorSeventh());
    majorSeventhInterval = new IntervalSymbol(strIntervals[17], IntervalFactory.getMajorSeventh());
    minorNinthInterval = new IntervalSymbol(strIntervals[18], IntervalFactory.getMinorNinth());
    majorNinthInterval = new IntervalSymbol(strIntervals[19], IntervalFactory.getMajorNinth());
    augmentedNinthInterval = new IntervalSymbol(strIntervals[20], IntervalFactory.getAugNinth());
    diminishedEleventhInterval = new IntervalSymbol(strIntervals[21],IntervalFactory.getDim11th());
    perfectEleventhInterval = new IntervalSymbol(strIntervals[22], IntervalFactory.getPerfect11th());
    augmentedEleventhInterval = new IntervalSymbol(strIntervals[23], IntervalFactory.getAug11th());
    perfectTwefthlnterval = new IntervalSymbol(strIntervals[24], IntervalFactory.getPerfect12th());
    minorThirteenthInterval = new IntervalSymbol(strIntervals[25], IntervalFactory.getMinor13th());
    majorThirteenthInterval = new IntervalSymbol(strIntervals[26], IntervalFactory.getMajor13th());
    augmentedThirteenthInterval = new IntervalSymbol(strIntervals[27], IntervalFactory.getAug13th());

    // Identificadores dos intervalos num, numA, numB, mumC e numD - AE
    numericIntervals.add(new IntervalSymbol(strIntervals[2], IntervalFactory.getMajorSecond()));
    numericIntervals.add(new IntervalSymbol(strIntervals[7], IntervalFactory.getPerfectFourth()));
    numericIntervals.add(new IntervalSymbol(strIntervals[10], IntervalFactory.getPerfectFifth()));
    numericIntervals.add(new IntervalSymbol(strIntervals[13], IntervalFactory.getMajorSixth()));
    numericIntervals.add(new IntervalSymbol(strIntervals[16], IntervalFactory.getMinorSeventh()));
    numericIntervals.add(new IntervalSymbol(strIntervals[19], IntervalFactory.getMajorNinth()));
    numericIntervals.add(new IntervalSymbol(strIntervals[22], IntervalFactory.getPerfect11th()));
    numericIntervals.add(new IntervalSymbol(strIntervals[26], IntervalFactory.getMajor13th()));

    intervalosNumA.add(new IntervalSymbol(strIntervals[2], IntervalFactory.getMajorSecond()));
    intervalosNumA.add(new IntervalSymbol(strIntervals[7], IntervalFactory.getPerfectFourth()));
    intervalosNumA.add(new IntervalSymbol(strIntervals[13], IntervalFactory.getMajorSixth()));

    intervalosNumB.add(new IntervalSymbol(strIntervals[19], IntervalFactory.getMajorNinth()));
    intervalosNumB.add(new IntervalSymbol(strIntervals[22], IntervalFactory.getPerfect11th()));
    intervalosNumB.add(new IntervalSymbol(strIntervals[26], IntervalFactory.getMajor13th()));

    intervalosNumC.add(new IntervalSymbol(strIntervals[2], IntervalFactory.getMajorSecond()));
    intervalosNumC.add(new IntervalSymbol(strIntervals[7], IntervalFactory.getPerfectFourth()));
    intervalosNumC.add(new IntervalSymbol(strIntervals[19], IntervalFactory.getMajorNinth()));
    intervalosNumC.add(new IntervalSymbol(strIntervals[22], IntervalFactory.getPerfect11th()));

    intervalosNumD.add(new IntervalSymbol(strIntervals[2], IntervalFactory.getMajorSecond()));
    intervalosNumD.add(new IntervalSymbol(strIntervals[7], IntervalFactory.getPerfectFourth()));
    intervalosNumD.add(new IntervalSymbol(strIntervals[10], IntervalFactory.getPerfectFifth()));
    intervalosNumD.add(new IntervalSymbol(strIntervals[13], IntervalFactory.getMajorSixth()));
